...
import { fetchAllCustomers, fetchAllProfileByRole } from '../../../APICalls';
...
import ProviderModel from '../common/modals/providers-modal';
                ...
                >
                  ...
                  <Column
                    ...
                    body={(rowData) => (
                      <span
                        className={
                          rowData.isVerified === 'Active' ? 'badge-active' : ''
                        }
                      >
