              ...
              <div className="blog grid-blog">
                ...
                <div className="blog-content">
                  ...
                  <div className="blog-info">
                    <div
                      className="action-search d-flex justify-content-between"
                      style={{ width: '100%' }}
                    >
                      {/* <Link to={''}> */}
                      <div
                        onClick={() =>
                          navigate('/admin/edit-blog', { state: blog })
                        }
                        className="serv-edit"
                      >
                        <Icon.Edit className="react-feather-custom text-success" />
                      </div>
                      {/* </Link> */}
                      <Link
                        to="#"
                      ...
                      >
                        <Icon.Trash2 className="react-feather-custom text-danger" />
                      </Link>
                    </div>
                    {/* <span>
