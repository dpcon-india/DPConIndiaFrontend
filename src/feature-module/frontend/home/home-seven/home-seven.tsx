              ...
              <div className="col-md-4">
                <div className="work-box-seven aos" data-aos="fade-up">
                  <div className="work-icon-seven">
                    <span>
                      <ImageWithBasePath
                        src="assets/img/icons/work-seven-3.svg"
                        alt="img"
                      />
                    </span>
                  </div>
              ...
              <div className="col-md-4">
                <div className="work-box-seven aos" data-aos="fade-up">
                  <div className="work-icon-seven">
                    <span>
                      <ImageWithBasePath
                        src="assets/img/icons/work-seven-2.svg"
                        alt="img"
                      />
                    </span>
                  </div>
              ...
              <div className="col-md-4">
                <div className="work-box-seven aos" data-aos="fade-up">
                  <div className="work-icon-seven">
                    <span>
                      <ImageWithBasePath
                        src="assets/img/icons/work-seven-1.svg"
                        alt="img"
                      />
                    </span>
                  </div>
                ...
                <Slider {...topProjects} className="top-projects-seven">
                  <div className="providerset">
                    <div className="providerset-img providerset-img-seven ">
                      <Link to={routes.providerDetails}>
                        <ImageWithBasePath
                          src="assets/img/providers/provider-35.jpg"
                          alt="img"
                        />
                      </Link>
                      <div className="fav-item d-flex align-items-center justify-content-between">
                        <i
                          className="fa fa-check-circle fav-icons"
                          aria-hidden="true"
                        />
                        <Link to="javascript:void(0)" className="fav-icon">
                          <i className="feather icon-heart" />
                    ...
                    <div className="providerset-content providerset-content-seven">
                      <div className="providerset-price">
                        <div className="providerset-name">
                          ...
                          <span className="text-dark-blue">Electrician</span>
                        </div>
                        <div className="rate">
                          <i className="fas fa-star filled" />
                          <span>4.8</span>
                  ...
                  <div className="providerset">
                    <div className="providerset-img providerset-img-seven ">
                      <Link to={routes.providerDetails}>
                        <ImageWithBasePath
                          src="assets/img/providers/provider-36.jpg"
                          alt="img"
                        />
                      </Link>
                      <div className="fav-item d-flex align-items-center justify-content-between">
                    ...
                    <div className="providerset-content providerset-content-seven">
                      <div className="providerset-price">
                        <div className="providerset-name">
                          ...
                          <span className="text-dark-blue">Construction</span>
                        </div>
                        <div className="rate">
                          <i className="fas fa-star filled" />
                          <span>4.8</span>
                  ...
                  <div className="providerset">
                    <div className="providerset-img providerset-img-seven ">
                      <Link to={routes.providerDetails}>
                        <ImageWithBasePath
                          src="assets/img/providers/provider-33.jpg"
                          alt="img"
                        />
                      </Link>
                      <div className="fav-item d-flex align-items-center justify-content-between">
                    ...
                    <div className="providerset-content providerset-content-seven">
                      <div className="providerset-price">
                        <div className="providerset-name">
                          ...
                          <span className="text-dark-blue">Computer</span>
                        </div>
                        <div className="rate">
                          <i className="fas fa-star filled" />
                          <span>4.9</span>
                  ...
                  <div className="providerset">
                    <div className="providerset-img providerset-img-seven ">
                      <Link to={routes.providerDetails}>
                        <ImageWithBasePath
                          src="assets/img/providers/provider-34.jpg"
                          alt="img"
                        />
                      </Link>
                      <div className="fav-item d-flex align-items-center justify-content-between">
            ...
            <div className="row">
              <div className="col-md-12 text-center">
                ...
                >
                  <h2>Pricing Plan</h2>
                  <p>
                    Designed to effectively communicate your service offerings
            ...
            <div className="row aos" data-aos="fade-up">
              <div className="col-lg-4 col-sm-12">
                <div className="pricing-plans price-new pricing-plans-seven">
                  <div className="pricing-plans-img">
                    <ImageWithBasePath
                      src="assets/img/icons/pricing-seven-3.svg"
                      alt="image"
                    />
                  </div>
                  ...
                  <div className="pricing-planscontent pricing-planscontent-seven">
                    ...
                    <div className="price-bg">
                      <ImageWithBasePath
                        src="assets/img/bg/price-bg-vector.png"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="col-lg-4 col-sm-12">
                <div className="pricing-plans price-new pricing-plans-seven active-seven">
                  ...
                  <div className="pricing-plans-img">
                    <ImageWithBasePath
                      src="assets/img/icons/pricing-seven-2.svg"
                      alt="image"
                    />
                  </div>
                  <div className="pricing-planshead">
              ...
              <div className="col-lg-4 col-sm-12">
                <div className="pricing-plans price-new pricing-plans-seven">
                  <div className="pricing-plans-img">
                    <ImageWithBasePath
                      src="assets/img/icons/pricing-seven-1.svg"
                      alt="image"
                    />
                  </div>
                  <div className="pricing-planshead">
