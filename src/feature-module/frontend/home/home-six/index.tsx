      ...
      <section className="hero-section-six  p-0">
        <div className="hero-section-overlay-img d-none d-lg-block">
          <div className="gradient-img">
            <ImageWithBasePath
              src="assets/img/bg/index-g-overlay-gradient.png"
              alt="img"
              className="img-fluid"
            />
          </div>
          <div className="white-circle">
            <ImageWithBasePath
              src="assets/img/bg/index-6-left-circle.png"
              alt="img"
              className="img-fluid"
            />
          </div>
          <div className="main-bg">
            <ImageWithBasePath
              src="assets/img/bg/index-6-bg.png"
              alt="img"
              className="img-fluid"
            />
          </div>
          <div className="top-circle">
            <ImageWithBasePath
              src="assets/img/bg/index-6-top-circle.png"
              alt="img"
              className="img-fluid"
            />
          </div>
          <div className="right-img">
            <ImageWithBasePath
              src="assets/img/bg/index-6-right-img.png"
              alt="img"
              className="img-fluid"
            />
          </div>
          <div className="oval-img">
            <ImageWithBasePath
              src="assets/img/bg/index-6-oval-img.png"
              alt="img"
              className="img-fluid"
            />
          </div>
                ...
                <div className="home-banner-six-bottom">
                  <div className="home-banner-six-detergent">
                    <span className="rounded-circle">
                      <ImageWithBasePath
                        src="assets/img/icons/window-cleaner.svg"
                        alt="icon"
                      />
                    </span>
                  ...
                  <h1 className="mb-2 display-5">
                    ...
                    <span className="text-dark-blue">You Can Trust</span>
                  </h1>
                  <p>
              ...
              <div className="total-client-all">
                ...
                <div>
                  <p className="total-client-content">
                    Informed decisions and contributes to the overall quality of
                    the marketplace. It also provides valuable insights to the
                    provider for future improvements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6 col-12">
              <div className="our-company-six">
                <p>
                  ...
                  looking to access specialized skills and support. By following
                  these tips, you can navigate the marketplace effectively, find
                  the right service providers, and enhance your business
                  operations. Ready to get started?
                </p>
              </div>
              <div className="aboutus-companyimg">
                <div className="our-company-overlay-img d-none d-lg-block">
                  <ImageWithBasePath
                    src="assets/img/bg/buttom-wave.png"
                    alt="img"
                  />
                </div>
                <Link to="#">
                  <ImageWithBasePath
                    src="assets/img/services/service-84.png"
                    alt="img"
                  />
                </Link>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/apporment-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/covid-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/office-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/move-in.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/commercial-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/window-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 d-flex">
              <div className="get-service-main w-100">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/carpet-cleaning.svg"
                    alt="image"
                  />
                </span>
                <Link to={routes.serviceDetails1}>
              ...
              >
                ...
                <div className="service-content service-content-six">
                  ...
                  <p>
                    ...
                    is the access to a wide range of services.
                  </p>
