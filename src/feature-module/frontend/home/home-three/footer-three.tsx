            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                <div className="footer-widget">
                  ...
                  <div className="footer-content footer-content-three">
                    <p>
                      Online platform where you can discover and book services
                      from a variety of salons and beauty professionals. From
                      haircuts and styling to massages and manicures, we offer a
                      convenient way to find the perfect service for your needs.
                    </p>
                  </div>
                </div>
                {/* /Footer Widget */}
              ...
              <div className="col-xl-3 col-lg-3 col-md-6">
                ...
                <div className="footer-widget footer-menu footer-menu-three">
                  ...
                  <p className="fs-16">DPConIndia@example.com</p>
                </div>
                <div className="footer-widget footer-menu footer-menu-three">
                  <h2 className="footer-title footer-subtitle-three fs-14">
                ...
                <div className="col-lg-4 col-md-6 d-flex">
                  <div className="copyright-text copyright-color">
                    <p className="mb-0 fs-16">
                      &copy; 2024 DPConIndia. All Rights Reserved.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-4 col-md-6  d-flex justify-content-lg-center">
                  <div className="copyright-menu">
                    <ul className="policy-menu">
                      ...
                      <li>
                        <Link to="#">
                          <i className="ti ti-brand-twitter-filled"></i>
                        </Link>
                      </li>
                      <li>
                        <Link to="#">
