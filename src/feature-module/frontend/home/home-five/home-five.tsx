          ...
          <div className="floating-five-main d-none d-lg-block">
            <div className="floating-five-buttom">
              <div className="floating-five-buttom-all">
                <h5 className="text-dark-blue">1430 k</h5>
                <p>Cars Washed</p>
              </div>
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              >
                ...
                <p>
                  A featured services marketplace typically offers a platform
                  where various service providers.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="service-content service-content-five">
                  <div className="feature-content-bottom">
                    ...
                    <Link to="#">
                      <i className="feather icon-users text-dark-blue me-2" />
                      15
                    </Link>
                  </div>
                </div>
                ...
                <div className="service-img">
                  ...
                  <div className="fav-item ">
                    ...
                    <Link
                      ...
                      className={`fav-icon fav-icon-five ${selectedItems[1] ? 'selected' : ''}`}
                    >
                ...
                <div className="service-img">
                  ...
                  <div className="fav-item ">
                    ...
                    <Link
                      ...
                      className={`fav-icon fav-icon-five ${selectedItems[2] ? 'selected' : ''}`}
                    >
                      <i className="feather icon-heart" />
                    </Link>
                  </div>
                ...
                <div className="service-img">
                  ...
                  <div className="fav-item ">
                    ...
                    <Link
                      ...
                      className={`fav-icon fav-icon-five ${selectedItems[3] ? 'selected' : ''}`}
                    >
                      <i className="feather icon-heart" />
                    </Link>
                  </div>
                ...
                <div className="works-five-main">
                  ...
                  <div className="works-five-bottom">
                    ...
                    <p>
                      ...
                      services using categories, filters.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="works-five-main">
                  ...
                  <div className="works-five-bottom">
                    ...
                    <p>
                      ...
                      services, they may select a best service
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="works-five-main">
                  ...
                  <div className="works-five-bottom">
                    ...
                    <p>
                      ...
                      service to the Customers &amp; Get leads
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-lg-8 col-md-12">
                  <div className="offering-five-main">
                    ...
                    <p>
                      ...
                      includes a description of their services, pricing,
                      availability, and any special offers or packages.
                    </p>
                    <div className="offering-five-button">
                      <Link to={routes.freeTrail} className="btn btn-primary">
                        <i className="ti ti-users me-2 ms-0" /> Try 14 Days Free
                        Trial
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="service-img">
                    ...
                    <div className="fav-item ">
                      ...
                      <Link
                        ...
                        className={`fav-icon fav-icon-five ${selectedItems[4] ? 'selected' : ''}`}
                      >
                        <i className="feather icon-heart" />
                      </Link>
                    </div>
                  ...
                  <div className="service-img">
                    ...
                    <div className="fav-item ">
                      ...
                      <Link
                        ...
                        className={`fav-icon fav-icon-five ${selectedItems[5] ? 'selected' : ''}`}
                      >
                        <i className="feather icon-heart" />
                      </Link>
                    </div>
                  ...
                  <div className="service-img">
                    ...
                    <div className="fav-item ">
                      ...
                      <Link
                        ...
                        className={`fav-icon fav-icon-five ${selectedItems[6] ? 'selected' : ''}`}
                      >
                        <i className="feather icon-heart" />
                      </Link>
                    </div>
                  ...
                  <div className="service-img">
                    ...
                    <div className="fav-item ">
                      ...
                      <Link
                        ...
                        className={`fav-icon fav-icon-five ${selectedItems[7] ? 'selected' : ''}`}
                      >
                        <i className="feather icon-heart" />
                      </Link>
                    </div>
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              >
                ...
                <p>
                  Designed to effectively communicate your service offerings and
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              >
                ...
                <p>
                  Description highlights the value of client feedback, showcases
                  real testimonials
                </p>
              </div>
            </div>
                            ...
                            <div className="d-sm-flex align-items-start justify-content-center">
                              ...
                              <div>
                                <div>
                                  ...
                                  <p>
                                    Nay likely her length sooner thrown sex
                                    lively income. The expense windows adapted
                                    sir. Wrong widen drawn ample eat off doors
                                    money. Offending belonging promotion
                                    provision an be oh consulted ourselves it.
                                    Blessing welcomed ladyship she met humoured
                                ...
                                <div className="d-flex align-items-center justify-content-between">
                                  <div>
                                    <h6 className="fs-18 text-dark mb-1">
                                      Mansur
                                    </h6>
        ...
        <div className="container">
          <div className="col-md-12 text-center">
            ...
            >
              ...
              <p>
                Discover how our marketplace can support your business growth.
              </p>
            </div>
          </div>
          <Slider {...Three} className="car-testimonials-five-slider">
            ...
            <div className="partner-img">
              <ImageWithBasePath
                src="assets/img/partner/partner-10.svg"
                alt="img"
              />
            </div>
            <div className="partner-img">
              <ImageWithBasePath
                src="assets/img/partner/partner-11.svg"
                alt="img"
              />
            </div>
            <div className="partner-img">
              <ImageWithBasePath
                src="assets/img/partner/partner-12.svg"
                alt="img"
              />
            </div>
          </Slider>
            ...
            <div className="col-md-12 text-center">
              ...
              >
                ...
                <p>
                  ...
                  readers and provide a clear idea of what they can expect from
                  your blog
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="app-sec app-sec-five">
            <div className="row align-items-end">
                ...
                <div className="app-five-content">
                  <div className="col-md-12">
                    <div className="heading aos" data-aos="fade-up">
                      ...
                      <p>
                        Whether you&apos;re looking to our app brings everything
              ...
              <div className="col-lg-6 col-12">
                <div
                  className="appimg-set aos d-none d-lg-block"
                  data-aos="fade-up"
                >
                  <ImageWithBasePath
