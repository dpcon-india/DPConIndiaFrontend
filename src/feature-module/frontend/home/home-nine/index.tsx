    ...
    <div className="main-wrapper">
          ...
          <div className="top-bar-nine-all">
            ...
            <div className="top-bar-ryt">
              ...
              <div className="top-address">
                <span>
                  <ImageWithBasePath
                    src="assets/img/icons/global-nine.svg"
                    alt="image"
                  />
                </span>
              ...
              <div className="top-btn">
                <Link to={routes.login} className="btn btn-primary">
                  <i className="feather icon-user"></i> Login
                </Link>
              </div>
            </div>
          </div>
              ...
              <div className="col-lg-6 col-md-10 mx-auto">
                ...
                >
                  <span className="badge badge-primary-transparent">
                    Welcome to DPConIndia Mechanic
                  </span>
          ...
          <div className="row">
            <div className="col-lg-6 col-12">
              <div className="safety-first-all aos" data-aos="fade-up">
                ...
                <p className="safety-para">
                  We stay ahead of industry trends and continuously seek
                  innovative solutions to better serve our clients.{' '}
                </p>
                <p>
                  Our forward-thinking approach ensures that you benefit from
                  the latest advancements and strategies.We operate with the
                  highest level of integrity and ethical standards. Our business
                  practices are designed to build long-term relationships based
                  on trust, respect, and mutual success. If you are going to use
                  a passage of Lorem Ipsum,
                </p>
                <p>
                  We adhere to rigorous quality standards to ensure that every
                  service we provide meets the highest levels of excellence. Our
                  commitment to quality is reflected in the results we deliver
                  and the satisfaction of our clients.Our team consists of
                  highly qualified professionals who are experts in their
                  fields. We conduct thorough vetting and ongoing training to
                  ensure that our team remains at the forefront of industry
            ...
            <div className="col-lg-6 col-12">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                  <div
                    className="safety-list safety-ryt-two aos"
                    data-aos="fade-up"
                  >
                    <ImageWithBasePath
              ...
              >
                ...
                >
                  ...
                  <div className="service-content service-feature-nine">
                    ...
                    <h5>
                      <Link to={routes.serviceDetails1}>
                        Car Audio Repair and Maintenance
                      </Link>
                    </h5>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="service-content service-feature-nine">
                    ...
                    <h5>
                      <Link to={routes.serviceDetails1}>
                        Engine Service and repair Maintenance
                      </Link>
                    </h5>
                  </div>
                </div>
      ...
      <section className="feature-service-nine section">
        <div className="container">
          ...
          <div className="row justify-content-center">
              ...
              <div className="service-widget service-widget-nine">
                ...
                <div className="service-content service-content-nine">
                  ...
                  <div className="feature-content d-flex align-items-center justify-content-between">
                    ...
                    <h5 className="text-dark-blue">$68.00</h5>
                  </div>
              ...
              <div className="service-widget service-widget-nine">
                ...
                <div className="service-content service-content-nine">
                  ...
                  <div className="feature-content d-flex align-items-center justify-content-between">
                    ...
                    <h5 className="text-dark-blue">$56.00</h5>
                  </div>
                  <div className="service-link">
                    <Link to={routes.booking} className="btn btn-light w-100">
                      Book Appointment
            ...
            <div
              className="btn-service-nine text-center aos"
              data-aos="fade-up"
            >
      ...
      <section className="choose-nine-section section">
        <div className="container">
          ...
          <div
            className="row justify-content-center g-4 aos"
            data-aos="fade-up"
          >
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 d-flex">
              <div className="reasonable-wrap bg-primary w-100">
                <ImageWithBasePath
                  src="assets/img/icons/choose-icon-3.svg"
                  alt="image"
                />
                <h5>Expert Mechanics</h5>
                <p>
                  Our expertise spans across ensuring that we have the skills
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 d-flex">
              <div className="reasonable-wrap bg-secondary w-100">
                <ImageWithBasePath
                  src="assets/img/icons/choose-icon-4.svg"
                  alt="image"
                />
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 d-flex">
              <div className="reasonable-wrap bg-dark w-100">
                <ImageWithBasePath
                  src="assets/img/icons/choose-icon-2.svg"
                  alt="image"
                />
                <h5>fast feature</h5>
                <p>
                  Our commitment to a customer-first approach means we go above
                  beyond to ensure
                </p>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 d-flex">
              <div className="reasonable-wrap w-100">
                <ImageWithBasePath
                  src="assets/img/icons/choose-icon-1.svg"
                  alt="image"
                />
                  ...
                  >
                    <div className="providerset providerset-nine">
                      <div className="providerset-img ">
                        <Link to={routes.providerDetails}>
                          <ImageWithBasePath
                            src="assets/img/mechanic/mechanic-01.jpg"
                            alt="img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="providerset providerset-nine">
                      <div className="providerset-img ">
                        <Link to={routes.providerDetails}>
                          <ImageWithBasePath
                            src="assets/img/mechanic/mechanic-02.jpg"
                            alt="img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="providerset providerset-nine">
                      <div className="providerset-img ">
                        <Link to={routes.providerDetails}>
                          <ImageWithBasePath
                            src="assets/img/mechanic/mechanic-03.jpg"
                            alt="img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="providerset providerset-nine">
                      <div className="providerset-img ">
                        <Link to={routes.providerDetails}>
                          <ImageWithBasePath
                            src="assets/img/mechanic/mechanic-04.jpg"
                            alt="img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="providerset providerset-nine">
                      <div className="providerset-img ">
                        <Link to={routes.providerDetails}>
                          <ImageWithBasePath
                            src="assets/img/mechanic/mechanic-05.jpg"
                            alt="img"
                          />
                        </Link>
                      </div>
      ...
      <section className="customer-review-section section">
        <div className="customer-side-main-all">
          <div className="customer-side-left-img">
            <ImageWithBasePath
              src="assets/img/customer-review-after.png"
              alt="image"
            />
          </div>
          <div className="customer-side-right-img">
            <ImageWithBasePath
              src="assets/img/customer-review-before.png"
              alt="image"
            />
          </div>
        </div>
              ...
              >
                <div className="customer-reviews-all aos" data-aos="fade-up">
                  ...
                  <p>
                    ...
                    businesses alike. Its interface is clean and intuitive,
                    making it easy to post jobs, browse profiles, and manage
                    projects. The range of services is impressive,
                  </p>
                </div>
            ...
            <div className="row align-items-center aos" data-aos="fade-up">
              <div className="col-lg-6 col-12">
                <div className="free-service-nine">
                  <div className="free-service-img-one">
                    <ImageWithBasePath
                      src="assets/img/service-img-9.jpg"
                      alt="image"
                    />
                    <ImageWithBasePath
                  ...
                  <div className="free-service-img-two">
                    <ImageWithBasePath
                      src="assets/img/service-img-10.jpg"
                      alt="image"
                    />
                  </div>
                  <ImageWithBasePath
              ...
              <div className="col-lg-6 col-12">
                <div className="free-service-bottom-content">
                  ...
                  <p>
                    Whether you&apos;re looking to our app brings everything you
          ...
          <div className="row">
            ...
            >
              <div className="partner-img">
                <ImageWithBasePath
                  src="assets/img/partner/partner-01.svg"
                  alt="img"
                />
              </div>
              <div className="partner-img">
                <ImageWithBasePath
                  src="assets/img/partner/partner-02.svg"
                  alt="img"
                />
              </div>
              <div className="partner-img">
                <ImageWithBasePath
                  src="assets/img/partner/partner-03.svg"
                  alt="img"
                />
              </div>
              <div className="partner-img">
                <ImageWithBasePath
                  src="assets/img/partner/partner-04.svg"
                  alt="img"
                />
              </div>
              <div className="partner-img">
                <ImageWithBasePath
                  src="assets/img/partner/partner-05.svg"
                  alt="img"
                />
              </div>
              <div className="partner-img">
