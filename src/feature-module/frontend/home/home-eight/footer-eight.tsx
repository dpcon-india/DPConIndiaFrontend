          ...
          <div className="row">
            ...
            <div className="col-xl-3 col-lg-3 col-md-6">
              ...
              <div className="footer-widget footer-side footer-menu-eight">
                ...
                <p>
                  The platform is straightforward, allowing users to post tasks
                  and receive from local{' '}
                </p>
                <div className="app-eight-bottom d-flex mb-4">
                  <Link to="#" className="app-eight-content-inner me-2">
                    <ImageWithBasePath
            ...
            <div className="row text-center">
              <div className="col-md-12">
                <div className="copyright-text">
                  <p>Copyright 2024 © DPConIndia. All right reserved.</p>
                </div>
              </div>
            </div>
          </div>
