            ...
            <div className="modal-body">
              <form action="#">
                <div className="modal-wizard">
                  ...
                  >
                    <li
                      className={`d-flex align-items-center me-3 ${currentStep === 1 ? 'active' : currentStep > 1 ? 'activated' : ''}`}
                    >
                      <span>
                    ...
                    <li
                      className={`d-flex align-items-center me-3 ${currentStep === 2 ? 'active' : currentStep > 2 ? 'activated' : ''}`}
                    >
                      <span>
                    ...
                    <li
                      className={`d-flex align-items-center ${currentStep === 3 ? 'active' : currentStep > 3 ? 'activated' : ''}`}
                    >
                      <span>
                            ...
                            <div className="card-body">
                              <div className="accordion-item">
                                ...
                                >
                                  ...
                                  >
                                    <h6 className="fs-16 fw-medium ms-4">
                                      Monday
                                    </h6>
