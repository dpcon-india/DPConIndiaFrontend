          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              <ul>
                ...
                >
                  <Link to="/providers/dashboard">
                    <i className="ti ti-layout-grid" /> <span>Dashboard</span>
                  </Link>
                </li>
                <li
                  className={`${
                ...
                >
                  <Link to="/providers/provider-service">
                    <i className="ti ti-briefcase" /> <span>My Services</span>
                  </Link>
                </li>
                <li
                  className={`${
                ...
                <li className={`${activeRouterPath3() ? 'active' : ''}`}>
                  <Link to={routes.staffList}>
                    <i className="ti ti-users" /> <span>Staffs</span>
                  </Link>
                </li>
                {/* <li className={`${activeRouterPath4() ? 'active' : ''}`}>
                  <Link to={routes.customerList}>
                    <i className="ti ti-user" /> <span>Customers</span>
                  </Link>
                </li> */}
                {/* <li
                  className={`${
                    activeRouterPath('/providers/provider-payout')
                      ? 'active'
                      : ''
                  }`}
                >
                  <Link to={'/providers/provider-payout'}>
                    <i className="ti ti-wallet" /> <span>Payout</span>
                  </Link>
                </li> */}
                {/* <li
                className={`${
              ...
              >
                ...
                {/* <li
                  className={`${
                    activeRouterPath('/providers/provider-offer')
                      ? 'active'
                      : ''
                  }`}
                >
                ...
                <li
                  className={`${
                    activeRouterPath('/providers/provider-review')
                      ? 'active'
                      : ''
                  }`}
                >
                  <Link to="/providers/provider-review">
                    <i className="ti ti-star" /> <span>Reviews</span>
                  </Link>
                </li>
                <li
                  className={`${
                ...
                >
                  <Link to={routes.providerEnquiry}>
                    <i className="ti ti-mail" /> <span>Enquiries</span>
                  </Link>
                </li> */}
                <li
                  className={`${
                ...
                >
                  <Link to="/providers/provider-earnings">
                    <i className="ti ti-cash-banknote" /> <span>Earnings</span>
                  </Link>
                </li>
                {/* <li
                className={`${
              ...
              >
                ...
                >
                  <Link to="/providers/provider-chat">
                    <i className="ti ti-messages" /> <span>Chat</span>
                  </Link>
                </li> */}
                {/* <li className={`submenu `}>
                  ...
                  <ul style={{ display: subdroptoggle ? 'block' : 'none' }}>
                    <li>
                      <Link
                        to="/providers/settings/provider-appointment-settings"
                        className={`${
                    ...
                    <li>
                      <Link
                        to="/providers/settings/provider-social-profile"
                        className={`${
                          activeRouterPath(
                    ...
                    <li>
                      <Link
                        to="/providers/settings/provider-security-settings"
                        className={`${
                          activeRouterPath(
                    ...
                    <li>
                      <Link
                        to="/providers/settings/provider-plan"
                        className={`${
                      ...
                      >
                        <i className="ti ti-chevrons-right me-2" /> Plan &amp;
                        Billings
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/providers/settings/payment-setting"
                        className={`${
                          activeRouterPath(
                            '/providers/settings/payment-setting',
                          )
                            ? 'active'
                            : ''
                        }`}
                    ...
                    <li>
                      <Link
                        to="/providers/settings/provider-notification"
                        className={`${
                          activeRouterPath(
                    ...
                    <li>
                      <Link
                        to="/providers/settings/provider-connected-apps"
                        className={`${
                          activeRouterPath(
                      ...
                      >
                        <i className="ti ti-chevrons-right me-2" /> Connected
                        Apps
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/providers/settings/verification"
                        className={`${
                          activeRouterPath(
                      ...
                      >
                        <i className="ti ti-chevrons-right me-2" /> Profile
                        Verification
                      </Link>
                    </li>
                    <li>
                ...
                <li>
                  <Link to={routes.login}>
                    <i className="ti ti-logout-2" /> <span>Logout</span>
                  </Link>
                </li> */}
              </ul>
            </div>
