                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="invoice-address">
                            ...
                            <ul>
                              <li>DPConIndia</li>
                              <li>
                                367 Hillcrest Lane, Irvine, California, United
                                States
                              </li>
                              <li className="mb-0">DPConIndia@example.com</li>
                            </ul>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="invoice-address d-flex justify-content-end">
                            <div>
                              ...
                              <ul>
                                ...
                                <li>
                                  1620 Jerry Dove Drive Myrtle Beach, SC 29577
                                </li>
                              ...
                              <table className="table datatable">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <p className="fs-14 text-gray">
                                        Expert house cleaning for a<br />{' '}
                                        sparkling space.
                                      </p>
                                    </td>
                                    <td>
                            ...
                            <div className="invoice-total">
                              <ul>
                                ...
                                <li className="d-flex justify-content-between gap-5 mb-0">
                                  Total{' '}
                                  <span className="text-dark">$252.36</span>
                                </li>
                              </ul>
                            </div>
                          </div>
                        ...
                        <div className="invoice-terms rounded">
                          ...
                          <ul>
                            ...
                            <li className="mb-0">
                              Cancellations must be made within 10 days of
                              service. Refunds are subject to review and may not
                              be granted if the service has been substantially
                              performed.
                            </li>
                          </ul>
                        </div>
