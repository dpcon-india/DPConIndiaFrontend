export const all_routes = {
  ...
  serviceDetails1: '/services/service-details',
  path: "/services/:id",
  ...
  // staff module path
  staff: '/staff/*',
  staffDashboard: '/staff/staff-dashboard',
  staffBooking: '/staff/staff-booking',
  staffFavourite: '/staff/staff-favourite',
  staffNotifications: '/staff/staff-notifications',
  staffProfile: '/staff/settings/staff-profile',
  staffSecurity: '/staff/settings/staff-security',
  staffNotification: '/staff/settings/notification',
  staffConnectedApps: '/staff/settings/connected-apps',
  staffBookingCalendar: '/staff/staff-booking-calendar',
  staffChat: '/staff/staff-chat',
  staffReviews: '/staff/staff-reviews',
  staffWallet: '/staff/staff-wallet',
  staffdeviceManagement: '/staff/settings/device-management',
  staffLoginActivity: '/staff/settings/login-activity',

  staffcommonNotification: '/staff/notification',
  ...
  appointment: '/admin/support/appointment',
  ...
  allGallery: '/admin/gallery/all-gallery',
  ...
  editService: '/admin/services/edit-service',
